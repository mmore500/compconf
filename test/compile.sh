...
python3 -m compconf --compconf-cslc "${CSLC}" --compconf-jq '. += {"x:u32": 42}' --compconf-verbose ./test/layout.csl --fabric-dims=8,3 --fabric-offsets=4,1 --channels=1 --memcpy -o out
